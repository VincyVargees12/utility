...
export class HomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.seoService.setPageMeta({
      ...
      description: 'Access dozens of free online tools for PDFs, images, text, and development. Fast, secure, and privacy-first utility platform.',
      keywords: 'online tools, pdf tools, image tools, text tools, developer tools, free utilities, online utilities',
      ogTitle: 'DataUtil - One Platform. Dozens of Powerful Online Utilities',
      ogDescription: 'Convert files, edit documents, transform text, and work with developer utilities on one modern platform.',
    ...
    this.seoService.addStructuredData({
      ...
      '@type': 'WebApplication',
      'name': 'DataUtil',
      'description': 'Free online utility platform with dozens of tools for PDF, images, text manipulation, and developer utilities.',
