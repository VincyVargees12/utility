  ...
  private readonly categories: Record<string, Category> = {
    pdf: {
      ...
      tools: [
        ...
        { id: 'pdf-to-word', name: 'PDF to Word', description: 'Easily convert your PDF files into easy to edit DOC and DOCX documents.', icon: '📝', route: '/categories/pdf/pdf-to-word', category: 'convert' },
        { id: 'word-to-pdf', name: 'Word to PDF', description: 'Make DOC and DOCX files easy to read by converting them to PDF.', icon: '📄', route: '/categories/pdf/word-to-pdf', category: 'convert' },
        { id: 'pdf-to-excel', name: 'PDF to Excel', description: 'Pull data straight from PDFs into Excel spreadsheets in a few short seconds.', icon: '📊', route: '/categories/pdf/pdf-to-excel', category: 'convert' },
        { id: 'excel-to-pdf', name: 'Excel to PDF', description: 'Make XLSX and XLS format spreadsheets easy to read by converting them to PDF.', icon: '📈', route: '/categories/pdf/excel-to-pdf', category: 'convert' },
        { id: 'pdf-to-ppt', name: 'PDF to PowerPoint', description: 'Turn your PDF files into easy to edit PPT and PPTX slideshows.', icon: '📽️', route: '/categories/pdf/pdf-to-ppt', category: 'convert' },
        { id: 'ppt-to-pdf', name: 'PowerPoint to PDF', description: 'Make PPT and PPTX slideshows easy to view by converting them to PDF.', icon: '🎬', route: '/categories/pdf/ppt-to-pdf', category: 'convert' },
        ...
        { id: 'edit-pdf', name: 'Edit PDF', description: 'Add text, images, shapes or freehand annotations to a PDF document.', icon: '✏️', route: '/categories/pdf/edit-pdf', category: 'edit' }
      ]
    },
    images: {
      id: 'images',
    ...
    text: {
      ...
      tools: [
        ...
        { id: 'text-difference', name: 'Text Difference', description: 'Compare two texts and highlight the differences.', icon: '⚖️', route: '/categories/text/text-difference', category: 'analyze' },
        { id: 'random-text', name: 'Random Text Generator', description: 'Generate random text, lorem ipsum, or placeholder content.', icon: '🎲', route: '/categories/text/random-text', category: 'generate' },
        { id: 'slug-generator', name: 'URL Slug Generator', description: 'Convert text into URL-friendly slugs.', icon: '🔗', route: '/categories/text/slug-generator', category: 'transform' }
      ]
    },
    developer: {
      id: 'developer',
      ...
      color: '#3B82F6',
      tools: [
        { id: 'json-formatter', name: 'JSON Formatter', description: 'Format and beautify JSON with syntax highlighting.', icon: '{ }', route: '/categories/developer/json-formatter', category: 'format' },
        { id: 'json-validator', name: 'JSON Validator', description: 'Validate JSON syntax and structure with detailed error messages.', icon: '✓', route: '/categories/developer/json-validator', category: 'validate' },
        { id: 'xml-formatter', name: 'XML Formatter', description: 'Format and beautify XML documents.', icon: '<>', route: '/categories/developer/xml-formatter', category: 'format' },
        { id: 'sql-formatter', name: 'SQL Formatter', description: 'Format SQL queries for better readability.', icon: '🗄️', route: '/categories/developer/sql-formatter', category: 'format' },
        { id: 'html-formatter', name: 'HTML Formatter', description: 'Format and beautify HTML code.', icon: '🌐', route: '/categories/developer/html-formatter', category: 'format' },
        { id: 'css-beautifier', name: 'CSS Beautifier', description: 'Format and beautify CSS stylesheets.', icon: '🎨', route: '/categories/developer/css-beautifier', category: 'format' },
        { id: 'js-minifier', name: 'JavaScript Minifier', description: 'Minify JavaScript code to reduce file size.', icon: '⚡', route: '/categories/developer/js-minifier', category: 'optimize' },
        { id: 'base64-encode', name: 'Base64 Encode/Decode', description: 'Encode and decode Base64 strings.', icon: '🔐', route: '/categories/developer/base64', category: 'encode' },
        { id: 'url-encoder', name: 'URL Encoder/Decoder', description: 'Encode and decode URL components.', icon: '🔗', route: '/categories/developer/url-encoder', category: 'encode' },
        { id: 'jwt-decoder', name: 'JWT Decoder', description: 'Decode and verify JSON Web Tokens.', icon: '🎫', route: '/categories/developer/jwt-decoder', category: 'decode' },
        { id: 'uuid-generator', name: 'UUID Generator', description: 'Generate unique identifiers (UUIDs/GUIDs).', icon: '🔑', route: '/categories/developer/uuid-generator', category: 'generate' },
        { id: 'hash-generator', name: 'Hash Generator', description: 'Generate MD5, SHA1, SHA256, and other hashes.', icon: '#️⃣', route: '/categories/developer/hash-generator', category: 'generate' },
        { id: 'regex-tester', name: 'Regex Tester', description: 'Test regular expressions with live results.', icon: '🔍', route: '/categories/developer/regex-tester', category: 'test' },
        { id: 'color-picker', name: 'Color Picker', description: 'Pick colors and convert between HEX, RGB, HSL.', icon: '🎨', route: '/categories/developer/color-picker', category: 'tool' },
        { id: 'timestamp-converter', name: 'Timestamp Converter', description: 'Convert between Unix timestamps and dates.', icon: '⏰', route: '/categories/developer/timestamp', category: 'convert' }
      ]
    }
  };
